...
const AdminOperations = ({ admin }) => {
  ...
  return (
    <div className="admin-operations-container">
      {/* Left Section - Set Market Schedule */}
      ...
      <div className="admin-operations-section-add-stock">
        <h2>Add Stock</h2>
        <p>
          Add new stocks to the platform by providing details like stock symbol,
          price, and other relevant information. Only admins can add new stocks.
        </p>
        <button
